      ...
      <div className="flex gap-10 w-full">
        ...
        <div className="flex flex-col gap-10 justify-between w-5/12">
          ...
          <div className="flex w-full gap-4">
            <button className="bg-black text-xl text-white p-2 rounded-md flex-grow-[4] transition-all duration-300 hover:bg-stone-300 hover:text-black hover:font-extrabold shadow-lg" onClick={() => addToCart(currentProduct)}>Add to cart</button>
